...
<div class="space-y-6">
	<div>
		<h1 class="text-3xl font-bold tracking-tight text-foreground">Social Media</h1>
		<p class="text-muted-foreground mt-2">Manage social media links and icons.</p>
	</div>
	...
	<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
		...
		<div class="lg:col-span-1">
			<Card class="sticky top-8">
				<CardHeader>
					<CardTitle>Add New Social</CardTitle>
					<CardDescription>Link a new social platform.</CardDescription>
				</CardHeader>
				<CardContent>
					<form action="?/create" method="POST" use:enhance class="space-y-4">
						<div class="space-y-2">
							<label for="label" class="text-sm font-medium leading-none">Platform Name</label>
							<Input
								type="text"
								id="label"
								name="label"
						...
						<div class="space-y-2">
							<label for="href" class="text-sm font-medium leading-none">URL</label>
							<Input
								type="text"
								id="href"
								name="href"
		...
		<div class="lg:col-span-2">
			<Card>
				<CardHeader>
					...
					<CardDescription>Social media accounts linked to the project.</CardDescription>
				</CardHeader>
				<CardContent>
					<Table.Root>
						<Table.Header>
							...
							{#each data.socials as social}
								<Table.Row>
									...
									<Table.Cell class="text-right">
										<form action="?/delete" method="POST" use:enhance onsubmit={(e) => !confirm('Delete social?') && e.preventDefault()}>
