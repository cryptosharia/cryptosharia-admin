...
{#if form?.success}
	<div class="animate-in fade-in zoom-in-95 space-y-4 py-8 text-center duration-300">
		...
		<Button href="/login" variant="outline" class="mt-4">Go to Login</Button>
	</div>
{:else}
	<div class="mb-6">
		<h2 class="text-xl font-bold text-foreground">Create an Account</h2>
		<p class="mt-1 text-sm text-muted-foreground">
			Register and wait for admin approval to get started.
		</p>
	</div>
	...
	>
		<div class="space-y-2">
			<label for="name" class="text-sm leading-none font-medium">Full Name</label>
			<Input
				type="text"
				id="name"
				name="name"
